...
import { saveToDynamo, readFromDynamo  } from '/opt/nodejs/dynamo/index.js';
...
export const handler = async (event) => {
    ...
    try {
        ...
        logInfo("Auth data ", {userData,hashData});
        ...
        logInfo("reading dynamo", PK);

        const result = await readFromDynamo(TABLE_NAME, PK, SK);

        logInfo("readFromDynamo", result);
        ...
        logInfo("profileData", profileData);
